...
mvn clean test spring-boot:start exec:exec spring-boot:stop -Dscoring.dir="${scoringDir}" -Dserver.port=8001 -Dspring-boot.run.arguments="--server.port=\${server.port}"
